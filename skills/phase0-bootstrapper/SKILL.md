...
### 0. Detect state
Run `python resources/scan.py <path> --no-write` and read `.state`:
- **virgin** → full install.
...
- `resources/output-schema.md` — artifact shapes and skeletons.
- `resources/safety-policy.md` — full write set, forbidden commands, consent rules.
- `resources/evidence-policy.md` — the four epistemic tags; citation format.
- `resources/scan.py` — the portable sensor (copy of `scripts/scan.py`).
- `resources/examples/standard-output/` — worked example: `AGENTS.md` + `CONTEXT.md` + ADR-0001.
